...
echo.
echo  ==========================================================================
echo   MODULO: RESTAURAR PORTATIL
...
# 1. Restore Power
Write-Host "`n   [-] Restaurando Esquemas de Energía de Fábrica..." -ForegroundColor Yellow
...
# 2. Processor Unlock Reversion
Write-Host "`n   [-] Eliminando registros de Turbo Boost forzado..." -ForegroundColor Yellow
$procPath = "HKLM:\SYSTEM\CurrentControlSet\Control\Power\PowerSettings\54533251-82be-4824-96c1-47b60b740d00\be337238-0d82-4146-a960-4f3749d470c7"
if (Test-Path $procPath) {
    Remove-ItemProperty -Path $procPath -Name "Attributes" -ErrorAction SilentlyContinue
}
Write-Host "   [OK] Configuración térmica restaurada." -ForegroundColor Green

Write-Host "`n   ======================================================" -ForegroundColor Cyan
Write-Host "      RESTAURACION COMPLETADA" -ForegroundColor Cyan
Write-Host "   ======================================================" -ForegroundColor Cyan
Write-Host "   El sistema ha vuelto a valores de fábrica." -ForegroundColor Yellow
