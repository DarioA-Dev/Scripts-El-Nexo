@echo off
:: ==========================================================
::   EL NEXO - MÁXIMO RENDIMIENTO (V3.5 EXTENDED) - PARTE 1
::   Ingeniería: Optimización de Kernel, Energía y Boot
:: ==========================================================
chcp 65001 >nul
...
timeout /t 2 >nul
:: ==========================================================
::   EL NEXO - MÁXIMO RENDIMIENTO (V3.5 EXTENDED) - PARTE 2
::   Ingeniería: Registro, Hardware, Servicios y Visuales
:: ==========================================================
